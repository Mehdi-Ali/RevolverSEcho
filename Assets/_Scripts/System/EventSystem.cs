...
public class EventSystem : MonoBehaviour
{
    ...
    public event Action<DamageableTarget,Transform, int> OnBulletHit;
    ...
    public void TriggerOnBulletHit(int bulletID, DamageableTarget target, Transform contactPoint)
    {
